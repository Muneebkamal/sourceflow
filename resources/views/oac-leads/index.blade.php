        ...
        <div class="col-md-12">
            <div class="page-title-head d-flex align-items-sm-center flex-sm-row flex-column">
                <div class="flex-grow-1">
                    <h4 class="fs-18 fw-semibold m-0">OAC Leads</h4>
                </div>
                        ...
                        <div class="row g-2 mb-0 align-items-center">
                            <div class="col-auto">
                                <button class="btn btn-soft-primary">
                                    <i class="ti ti-download fs-4 me-1"></i>Download Data
                                </button>
                            </div>
                        </div>
                    </form>
        ...
        <div class="col-md-6">
            <div class="d-flex align-items-center gap-1">
                <select class="form-select w-100">
                    <option>All Lead Lists Group</option>
                    <option>OA Cheddar List #6</option>
                    <option>OA Feta List #1</option>
                </select>
                <select class="form-select w-100">
                    <option>All Lead Lists</option>
                    <option>2024-07-17</option>
                    <option>2024-07-16</option>
                    <option>2024-07-15</option>
                </select>
            </div>
        </div>
            ...
            <div id="table-section" class="card">
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table id="oac-leads-table" class="table align-middle w-100 mb-0 table-hover">
